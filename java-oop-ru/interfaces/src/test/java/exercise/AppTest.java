...
class AppTest {
    ...
    void testLength() {
        int expected = 5;
        AssertionsForClassTypes.assertThat(new ReversedSequence("Hello").length()).isEqualTo(expected);
    }

    @Test
    void testSubSequence() {
        String expected = "ol";
        AssertionsForClassTypes.assertThat(new ReversedSequence("Hello")
                .subSequence(0, 2).toString()).isEqualTo(expected);
    }

    @Test
    void testCharAt() {
        char expected = 'o';
        AssertionsForClassTypes.assertThat(new ReversedSequence("Hello").charAt(0)).isEqualTo(expected);
    }

    @Test
    void testToString() {
        String expected = "olleH";
        AssertionsForClassTypes.assertThat(new ReversedSequence("Hello").toString()).isEqualTo(expected);
    }
    // END
}
